    ...
    <div id="container">
        <div  class="d-flex flex-column flex-shrink-0 p-3 "  style=" position: fixed; width: 350px;height:800px;background-color: rgb(214, 95, 95);">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
              ...
              <li>
                <a href="add.html" id="Logout" class="nav-link text-white">
                  <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#speedometer2"></use></svg>
                  Add User
                </a>
              </li>
              <li>
                <a href="delete.html" id="AddUser" onclick="goToDeleteUser()" class="nav-link text-white">
                  <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#speedometer2"></use></svg>
                  Delete User
                </a>
              </li>
              <li>
                <a href="#" id="DeleteUser" onclick="goToDeleteUser()" class="nav-link text-white">
                  <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#speedometer2"></use></svg>
                  Log out
                </a>
              </li>
